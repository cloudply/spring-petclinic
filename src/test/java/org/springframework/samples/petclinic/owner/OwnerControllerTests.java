...
class OwnerControllerTests {
	...
	private static final String OWNERS_NEW_URL = "/owners/new";
	...
	void testInitCreationForm() throws Exception {
		mockMvc.perform(get(OWNERS_NEW_URL))
	...
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc
			.perform(post(OWNERS_NEW_URL).param("firstName", "Joe")
	...
	void testProcessCreationFormHasErrors() throws Exception {
		mockMvc
			.perform(post(OWNERS_NEW_URL).param("firstName", "Joe").param("lastName", "Bloggs").param("city", "London"))
			.andExpect(status().isOk())
