...
class OwnerControllerTests {
	...
	private static final String TEST_OWNER_LASTNAME = "Bloggs";
	...
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc
			.perform(post("/owners/new").param("firstName", "Joe")
				.param("lastName", TEST_OWNER_LASTNAME)
	...
	void testProcessCreationFormHasErrors() throws Exception {
		mockMvc
			.perform(post("/owners/new").param("firstName", "Joe").param("lastName", TEST_OWNER_LASTNAME).param("city", "London"))
			.andExpect(status().isOk())
