...
class OwnerControllerTests {
	...
	private static final String OWNERS_PAGE_REQUEST = "/owners?page=1";
	...
	private static final String LIBERTY_STREET_ADDRESS = "110 W. Liberty St.";
	...
	private Owner george() {
		...
		george.setAddress(LIBERTY_STREET_ADDRESS);
	...
	void testProcessCreationFormHasErrors() throws Exception {
		mockMvc
			.perform(post(OWNERS_NEW).param(FIRST_NAME, "Joe").param(LAST_NAME, LAST_NAME_BLOGGS).param("city", CITY_LONDON))
			.andExpect(status().isOk())
	...
	void testProcessFindFormSuccess() throws Exception {
		...
		mockMvc.perform(get(OWNERS_PAGE_REQUEST)).andExpect(status().isOk()).andExpect(view().name("owners/ownersList"));
	}
	...
	void testProcessFindFormByLastName() throws Exception {
		...
		mockMvc.perform(get(OWNERS_PAGE_REQUEST).param(LAST_NAME, "Franklin"))
			.andExpect(status().is3xxRedirection())
	...
	void testProcessFindFormNoOwnersFound() throws Exception {
		...
		mockMvc.perform(get(OWNERS_PAGE_REQUEST).param(LAST_NAME, "Unknown Surname"))
			.andExpect(status().isOk())
	...
	void testInitUpdateOwnerForm() throws Exception {
		mockMvc.perform(get(OWNERS_OWNER_ID_EDIT, TEST_OWNER_ID))
			...
			.andExpect(model().attribute(OWNER, hasProperty(ADDRESS, is(LIBERTY_STREET_ADDRESS))))
