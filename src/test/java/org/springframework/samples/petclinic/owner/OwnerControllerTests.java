...
class OwnerControllerTests {
	...
	private static final String OWNERS_FIRST_PAGE_URL = "/owners?page=1";
	...
	void testProcessFindFormSuccess() throws Exception {
		...
		mockMvc.perform(get(OWNERS_FIRST_PAGE_URL)).andExpect(status().isOk()).andExpect(view().name("owners/ownersList"));
	}
	...
	void testProcessFindFormByLastName() throws Exception {
		...
		mockMvc.perform(get(OWNERS_FIRST_PAGE_URL).param("lastName", "Franklin"))
			.andExpect(status().is3xxRedirection())
	...
	void testProcessFindFormNoOwnersFound() throws Exception {
		...
		mockMvc.perform(get(OWNERS_FIRST_PAGE_URL).param("lastName", "Unknown Surname"))
			.andExpect(status().isOk())
