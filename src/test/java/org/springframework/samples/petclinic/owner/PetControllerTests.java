...
class PetControllerTests {
	...
	private static final String PETS_FORM_URL = "/owners/{ownerId}/pets/new";
	...
	void testInitCreationForm() throws Exception {
		mockMvc.perform(get(PETS_FORM_URL, TEST_OWNER_ID))
	...
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc
			.perform(post(PETS_FORM_URL, TEST_OWNER_ID).param("name", PET_NAME)
				.param("type", PET_TYPE_HAMSTER)
				.param(BIRTH_DATE_PARAM, BIRTH_DATE))
	...
	void testProcessCreationFormHasErrors() throws Exception {
		mockMvc
			.perform(post(PETS_FORM_URL, TEST_OWNER_ID).param("name", PET_NAME)
				.param(BIRTH_DATE_PARAM, "2015-02-12"))
