...
class CrashControllerIntegrationTests {
	...
	private static final String CRASH_URL = "/oups";
	...
	void testTriggerExceptionJson() {
		ResponseEntity<Map<String, Object>> resp = rest.exchange(
				RequestEntity.get("http://localhost:" + port + CRASH_URL).build(),
		...
		assertThat(resp.getBody()).containsEntry("path", CRASH_URL);
	}
	...
	void testTriggerExceptionHtml() {
		...
		ResponseEntity<String> resp = rest.exchange("http://localhost:" + port + CRASH_URL, HttpMethod.GET,
