...
class CrashControllerIntegrationTests {
	...
	void testTriggerExceptionJson() {
		ResponseEntity<Map<String, Object>> resp = rest.exchange(
				RequestEntity.get("http://localhost:" + port + OUPS_ENDPOINT).build(),
		...
		assertThat(resp.getBody()).containsEntry("path", OUPS_ENDPOINT);
	}
	...
	void testTriggerExceptionHtml() {
		...
		ResponseEntity<String> resp = rest.exchange("http://localhost:" + port + OUPS_ENDPOINT, HttpMethod.GET,
