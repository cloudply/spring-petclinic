...
INSERT INTO vet_specialties (vet_id, specialty_id) VALUES (2, 1) ON CONFLICT ON CONSTRAINT vet_specialties_pkey DO NOTHING;
INSERT INTO vet_specialties (vet_id, specialty_id) VALUES (3, 2) ON CONFLICT ON CONSTRAINT vet_specialties_pkey DO NOTHING;
INSERT INTO vet_specialties (vet_id, specialty_id) VALUES (3, 3) ON CONFLICT ON CONSTRAINT vet_specialties_pkey DO NOTHING;
INSERT INTO vet_specialties (vet_id, specialty_id) VALUES (4, 2) ON CONFLICT ON CONSTRAINT vet_specialties_pkey DO NOTHING;
INSERT INTO vet_specialties (vet_id, specialty_id) VALUES (5, 1) ON CONFLICT ON CONSTRAINT vet_specialties_pkey DO NOTHING;
...
INSERT INTO users (id, username, password, enabled) VALUES (1, 'admin', '$2a$10$Ib9AEH0wGzKgb9EbX0uXZe7.X0jV9XU8/WUmecH.ikOkjyMqIkwNq', TRUE) ON CONFLICT (id) DO NOTHING;
INSERT INTO users (id, username, password, enabled) VALUES (2, 'user', '$2a$10$Ib9AEH0wGzKgb9EbX0uXZe7.X0jV9XU8/WUmecH.ikOkjyMqIkwNq', TRUE) ON CONFLICT (id) DO NOTHING;

INSERT INTO roles (id, username, role) VALUES (1, 'admin', 'ROLE_ADMIN') ON CONFLICT (id) DO NOTHING;
INSERT INTO roles (id, username, role) VALUES (2, 'admin', 'ROLE_USER') ON CONFLICT (id) DO NOTHING;
INSERT INTO roles (id, username, role) VALUES (3, 'user', 'ROLE_USER') ON CONFLICT (id) DO NOTHING;
