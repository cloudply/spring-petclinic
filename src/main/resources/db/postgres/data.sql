...
INSERT INTO specialties (id, name) SELECT 1, 'radiology' WHERE NOT EXISTS (SELECT * FROM specialties WHERE id=1);
INSERT INTO specialties (id, name) SELECT 2, 'surgery' WHERE NOT EXISTS (SELECT * FROM specialties WHERE id=2); 
INSERT INTO specialties (id, name) SELECT 3, 'dentistry' WHERE NOT EXISTS (SELECT * FROM specialties WHERE id=3);
...
INSERT INTO types (id, name) SELECT 1, 'cat' WHERE NOT EXISTS (SELECT * FROM types WHERE id=1);
INSERT INTO types (id, name) SELECT 2, 'dog' WHERE NOT EXISTS (SELECT * FROM types WHERE id=2);
INSERT INTO types (id, name) SELECT 3, 'lizard' WHERE NOT EXISTS (SELECT * FROM types WHERE id=3);
INSERT INTO types (id, name) SELECT 4, 'snake' WHERE NOT EXISTS (SELECT * FROM types WHERE id=4);
INSERT INTO types (id, name) SELECT 5, 'bird' WHERE NOT EXISTS (SELECT * FROM types WHERE id=5);
INSERT INTO types (id, name) SELECT 6, 'hamster' WHERE NOT EXISTS (SELECT * FROM types WHERE id=6);

INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 1, 'George', 'Franklin', '110 W. Liberty St.', 'Madison', 'WI', '6085551023' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=1);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 2, 'Betty', 'Davis', '638 Cardinal Ave.', 'Sun Prairie', 'WI', '6085551749' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=2);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 3, 'Eduardo', 'Rodriquez', '2693 Commerce St.', 'McFarland', 'WI', '6085558763' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=3);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 4, 'Harold', 'Davis', '563 Friendly St.', 'Windsor', 'WI', '6085553198' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=4);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 5, 'Peter', 'McTavish', '2387 S. Fair Way', 'Madison', 'WI', '6085552765' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=5);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 6, 'Jean', 'Coleman', '105 N. Lake St.', 'Monona', 'WI', '6085552654' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=6);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 7, 'Jeff', 'Black', '1450 Oak Blvd.', 'Monona', 'WI', '6085555387' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=7);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 8, 'Maria', 'Escobito', '345 Maple St.', 'Madison', 'WI', '6085557683' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=8);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 9, 'David', 'Schroeder', '2749 Blackhawk Trail', 'Madison', 'WI', '6085559435' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=9);
INSERT INTO owners (id, first_name, last_name, address, city, state, telephone) SELECT 10, 'Carlos', 'Estaban', '2335 Independence La.', 'Waunakee', 'WI', '6085555487' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=10);
