...
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'George', 'Franklin', '110 W. Liberty St.', 'Madison', 'WI', '6085551023' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=1);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'Betty', 'Davis', '638 Cardinal Ave.', 'Sun Prairie', 'WI', '6085551749' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=2);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'Eduardo', 'Rodriquez', '2693 Commerce St.', 'McFarland', 'WI', '6085558763' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=3);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'Harold', 'Davis', '563 Friendly St.', 'Windsor', 'WI', '6085553198' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=4);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'Peter', 'McTavish', '2387 S. Fair Way', 'Madison', 'WI', '6085552765' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=5);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'Jean', 'Coleman', '105 N. Lake St.', 'Monona', 'WI', '6085552654' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=6);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'Jeff', 'Black', '1450 Oak Blvd.', 'Monona', 'WI', '6085555387' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=7);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'Maria', 'Escobito', '345 Maple St.', 'Madison', 'WI', '6085557683' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=8);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'David', 'Schroeder', '2749 Blackhawk Trail', 'Madison', 'WI', '6085559435' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=9);
INSERT INTO owners (first_name, last_name, address, city, state, telephone) SELECT 'Carlos', 'Estaban', '2335 Independence La.', 'Waunakee', 'WI', '6085555487' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=10);
