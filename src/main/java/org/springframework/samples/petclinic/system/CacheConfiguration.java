...
class CacheConfiguration {
	...
	@Bean
	public CacheManagerCustomizer<JCacheCacheManager> petclinicCacheConfigurationCustomizer() {
		return cm -> cm.getCacheManager().createCache("vets", cacheConfiguration());
	}
